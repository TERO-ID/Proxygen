...
print(Fore.RED + ''' 
 _____            _     ___                 _               
/ _  / ___  _ __ | |_  / __\ ___  _ __ ___ | |__   ___ _ __ 
\// / / _ \| '_ \| __|/__\/// _ \| '_ ` _ \| '_ \ / _ \ '__|
 / //\ (_) | | | | |_/ \/  \ (_) | | | | | | |_) |  __/ |   
/____/\___/|_| |_|\__\_____/\___/|_| |_| |_|_.__/ \___|_|   
                                                            ''')
print(Fore.YELLOW + '''
 ▟▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▙
 ┃                                             ┋
 ┋           Наш канал - @pilahack             ┃
 ┃          Разработчик - @eToNuKTo            ┋
 ┋      Для остановки спама нажмите ctrl+z     ┃
 ┃     Номер вводить в международном формате   ┋
 ┋                                             ┃
 ▜█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█▛
 ▟▀                                           ▀▙
 ''')
 
phone = input(Fore.WHITE + '''Введите номер (+380, +7): ''')
threads = input(Fore.WHITE + '''Количество потоков: ''')
print(Fore.GREEN + '''Спам начинается! Чтобы остановить нажмите ctrl+Z или ctrl+C''')
iteration = 0
_name = ''
for x in range(12):
...
def infinity():
	while True:
		...
		try:
			...
			print(Fore.GREEN + '''{-} Ivi.ru Не отправлено!''')
		...
		try:
		   ...
		   print(Fore.RED + '''{-} Yaponchik Не отпралвено!''')
		...
		try:
		   ...
		   print(Fore.GREEN + '''{+} WebBankir Отпралвено!''')
		except:
		...
		try:
		   ...
		   print(Fore.GREEN + '''{+} Shop And Show Отпралвено!''')
		except:
